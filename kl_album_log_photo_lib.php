...
img{border:0}
#media-upload-header{width:52%;background-color: #F9F9F9; border-top:solid #F0F0F0 1px; margin-top:8px; height:20px;}
...
#attmsg{text-align:center; margin:40px 0px 0px 0px;}
</style>
</head>
