...
if(isset($_POST['album']) && isset($_FILES['Filedata'])){
	...
	define('KL_UPLOADFILE_PATH', '../../../content/plugins/kl_album-master/upload/');
	...
	switch (trim($_GET['action'])){
		...
		case 'del':
			...
			if($result){
				...
				$kl_album_info =  $DB->escape_string(serialize($kl_album_info));
		...
		case 'album_sort':
			...
			$new_kl_album_info = $DB->escape_string(serialize($new_kl_album_info));
		...
		case 'set_key':
			...
			$kl_album_config = $DB->escape_string(serialize($kl_album_config));
